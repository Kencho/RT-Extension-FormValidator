...
sub test_construction {
    ...
    try {
        FormValidator::RuleValidators::SingleField->new(field_name_regex => '.*my-field');
        FormValidator::RuleValidators::SingleField->new(field_name => 'my-field');
    }
    catch {
        fail('No exception was expected when trying to construct with the right arguments');
    };

    my $field_rule_validator = FormValidator::RuleValidators::SingleField->new(field_name_regex => '.*my-field');
...
sub test_reflective_construction {
    ...
    try {
        FormValidator::AbstractRuleValidator::Build('FormValidator::RuleValidators::SingleField', field_name_regex => '.*my-field');
        FormValidator::AbstractRuleValidator::Build('FormValidator::RuleValidators::SingleField', field_name => 'my-field');
    }
    catch {
        fail('No exception was expected when trying to construct with the right arguments');
    };

    my $field_rule_validator = FormValidator::AbstractRuleValidator::Build('FormValidator::RuleValidators::SingleField', field_name_regex => '.*my-field');
